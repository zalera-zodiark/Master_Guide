package com.charros_software.master_guide.reply_app.data.local

import com.charros_software.master_guide.R
import com.charros_software.master_guide.reply_app.data.Email
import com.charros_software.master_guide.reply_app.data.EmailAttachment
import com.charros_software.master_guide.reply_app.data.MailboxType
...
object LocalEmailsDataProvider {
    ...
    // Create a new [Email] that is a reply to the email with the given [replyTold].
